    ...
    <div id="container">
        ...
        <section>
            ...
            <form id="loginForm">
                ...
                <input name="first" type="text" id="first" value="First name">
                <input name="last" type="text" id="last" value="Last name">
                <input name="pwd" type="password" id="pwd" value="password">
                <div id="loginButton" class="button purple">Create user</div>
            </form>
